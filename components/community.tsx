...
import { formatTime, formatTimeToFull } from "@/lib/utils";
        ...
        <div className="flex bg-secondary rounded-lg px-3 py-2 items-center">
          ...
          <div className="flex flex-col ml-3">
            ...
            {isLoading ? (
              ...
              <span className="text-sm">{data?.active_fund.value || "0"}</span>
            )}
          </div>
        </div>
        <div className="flex bg-secondary rounded-lg px-3 py-2 items-center">
          ...
          <div className="flex flex-col ml-3">
            ...
            {isLoading ? (
              ...
              <span className="text-sm">{data?.holders.value || "0"}</span>
            )}
          </div>
        </div>
        <div className="flex bg-secondary rounded-lg px-3 py-2 items-center">
          ...
          <div className="flex flex-col ml-3">
            ...
            {isLoading ? (
              ...
              <span className="text-sm">{data?.community_mbrs.value || "0"}</span>
            )}
          </div>
        </div>
        <div className="flex bg-secondary rounded-lg px-3 py-2 items-center">
          ...
          <div className="flex flex-col ml-3">
            ...
            {isLoading ? (
              ...
              <span className="text-sm">{data?.active_mbrs_24h.value || "0"}</span>
            )}
          </div>
        </div>
      </div>
